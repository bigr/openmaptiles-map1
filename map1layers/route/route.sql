...
CREATE OR REPLACE FUNCTION get_hiking_route_color(col TEXT)
RETURNS TEXT AS $$
    SELECT CASE
	    WHEN col LIKE 'red:%' THEN 'red'
	    WHEN col LIKE 'blue:%' THEN 'blue'
...
CREATE OR REPLACE FUNCTION get_hiking_grade(col TEXT)
RETURNS TEXT AS $$
    SELECT CASE
	    WHEN col LIKE '%_bar' THEN 0
	    WHEN col LIKE '%_corner' THEN 1
...
CREATE OR REPLACE FUNCTION get_bicycle_grade(col TEXT)
RETURNS TEXT AS $$
    SELECT CASE
	    WHEN col IN ('icn','iwn') THEN 0
	    WHEN col IN ('ncn','nwn') THEN 1
